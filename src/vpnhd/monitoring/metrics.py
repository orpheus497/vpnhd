...
vpn_server_info = Info(
    'vpnhd_server',
    'VPN server information',
    ['version', 'provider', 'interface', 'hostname']
)

# VPN server uptime in seconds
vpn_server_uptime_seconds = Gauge(
    'vpnhd_server_uptime_seconds',
    'VPN server uptime in seconds'
)
...
vpn_clients_active = Gauge(
    'vpnhd_clients_active',
    'Number of active VPN clients'
)

# Total VPN clients configured
vpn_clients_total = Gauge(
    'vpnhd_clients_total',
    'Total number of configured VPN clients'
)
...
vpn_client_info = Info(
    ...
    ['client_name', 'internal_ip', 'allowed_ips']
)
...
vpn_last_key_rotation_timestamp_seconds = Gauge(
    'vpnhd_last_key_rotation_timestamp_seconds',
...
vpn_memory_usage_bytes = Gauge(
    'vpnhd_memory_usage_bytes',
    'VPN server memory usage in bytes',
    ['process']
)
...
vpn_last_backup_timestamp_seconds = Gauge(
    'vpnhd_last_backup_timestamp_seconds',
...
vpn_api_request_duration_seconds = Summary(
    'vpnhd_api_request_duration_seconds',
...
vpn_cli_commands_total = Counter(
    'vpnhd_cli_commands_total',
    'Total number of CLI command executions',
    ['command', 'status']
)
